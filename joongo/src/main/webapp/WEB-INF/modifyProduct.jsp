						...
						<div class="form-title-container">
							<table>
								<tr>
									...
									<td class="title-winput"><input type="text" id="title" name="title" placeholder="제목을 입력하세요" class="title-input" 
								...
								<tr>
									...
									<td>
										...
										<input type="text" id="price" name="price" placeholder="희망 가격을 입력해주세요 (숫자만 입력가능합니다)"
										value="${product.price }" class="price-input">
									</td>
								</tr>
							</table>
						</div>
