			...
			<div class="middle header-divTop">
				...
				<div class="header-divLogin">
					<c:if test="${loginUser != null }">
						...
						<form id='userpage-form' action="userPage.do" method="post">
							...
							<input type="hidden" name="userNo" value="${loginUser.userNo }"> <img src="/joongo/image/logoutImg.png" id="header-logoutImg">
				...
				<div class="header-divLogout">
					<c:if test="${loginUser == null }">
						...
						<span class="header-a" id="header-spanLogin">
							<i class="fa fa-user-circle-o" aria-hidden="true"></i> 로그인
						</span>
						<span class="header-a" id="header-spanJoin">
